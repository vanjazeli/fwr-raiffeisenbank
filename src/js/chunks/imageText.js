...
const imageText = {
	modules: document.querySelectorAll('.js-image-text'),
	decorations: document.querySelectorAll('.js-image-text-decoration'),
	...
	decorationSettings: function () {
		const showDecoration = (e) => {
			const decoration = e.target.querySelector('.js-image-text-decoration');
	...
	parallaxSettings: function () {
		this.modules.forEach((module) => {
			module.addEventListener('mousemove', (e) => {
				if (this.windowWidth > 992) {
					const parallaxOne = module.querySelectorAll('.js-image-text-parallax-one');
					const parallaxTwo = module.querySelectorAll('.js-image-text-parallax-two');
					const parallaxThree = module.querySelectorAll('.js-image-text-parallax-three');
